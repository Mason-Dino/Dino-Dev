	...
	return (
		<div>
            ...
            <section className='flex flex-col md:flex-row gap-3'>
                ...
                <div className='flex-1 text-center'>
                    ...
                    <div id="icons" className='flex flex-row justify-center gap-2 text-white'>
                        <Link href="https://www.instagram.com/dinosaur__dev/" target='_blank'>
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect width="20" height="20" x="2" y="2" rx="5" ry="5"/><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"/><line x1="17.5" x2="17.51" y1="6.5" y2="6.5"/></svg>
                        </Link>
                        <Link href="mailto:mason.n.dinosaur@gmail.com" target='_blank'>
                            <Mail />
                        </Link>
                        <Link href="https://github.com/Mason-Dino" target='_blank'>
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M15 22v-4a4.8 4.8 0 0 0-1-3.5c3 0 6-2 6-5.5.08-1.25-.27-2.48-1-3.5.28-1.15.28-2.35 0-3.5 0 0-1 0-3 1.5-2.64-.5-5.36-.5-8 0C6 2 5 2 5 2c-.3 1.15-.3 2.35 0 3.5A5.403 5.403 0 0 0 4 9c0 3.5 3 5.5 6 5.5-.39.49-.68 1.05-.85 1.65-.17.6-.22 1.23-.15 1.85v4"/><path d="M9 18c-4.51 2-5-2-7-2"/></svg>
                        </Link>
                        <Link href="https://www.linkedin.com/in/mason-norberg-920bab241/" target='_blank'>
            ...
            <section className="flex flex-col text-center justify-content items-center">
                ...
                <Project 
                    Name="Cyber Academy Enrichment Leader"
                ...
                <Project 
                    ...
                    Description={"Jan 2025 - Present\nServed as a Resident Assistant, fostering a safe, inclusive, and supportive living environment for over 38 residents. Planned and executed community-building programs, resolved conflicts, and enforced university policies to promote personal and academic success."}
                    Icon="User"
                    code={false}
                    download={false}
                    website={false}
